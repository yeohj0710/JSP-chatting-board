			...
			<table class="table table-bordered table-hover" style="text-align:center; border:1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><textarea class="form-control" rows="10" name="boardContent" maxlength="2048" placeholder="글 내용을 입력하세요."><%= board.getBoardContent().replace("&nbsp;", " ").replace("&lt;", "<").replace("&gt", ">;").replace("<br>", "\n") %></textarea></td>
					</tr>
					<tr>
