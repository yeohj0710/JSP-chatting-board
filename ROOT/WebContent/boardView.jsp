...
<%
	...
	try {
		...
		session.setAttribute("messageType", "오류 메시지");
		session.setAttribute("messageContent", "잘못된 페이지 번호입니다.");
...
<body>
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="index.jsp">실시간 채팅 웹페이지</a>
		</div>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				...
				<tr>
					<th style="background-color: #fafafa; color: #0000000; width: 70px;"><h5 style="color: black">번호</h5></th>
					<th style="background-color: #fafafa; color: #0000000;"><h5 style="color: black">제목</h5></th>
					<th style="background-color: #fafafa; color: #0000000;"><h5 style="color: black">작성자</h5></th>
					<th style="background-color: #fafafa; color: #0000000; width: 100px"><h5 style="color: black">작성일자</h5></th>
					<th style="background-color: #fafafa; color: #0000000; width: 70px"><h5 style="color: black">조회수</h5></th>
				</tr>
			</thead>
			<tbody>
			<%
			...
			%>
				<tr>
					...
					%>
							<li><span class="glyphicon glyphicon-chevron-left" style="color: gray;"></span></a></li>
					<%		
						}
